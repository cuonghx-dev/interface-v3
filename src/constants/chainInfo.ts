...
import { ARBITRUM_LIST, CELO_LIST, JOC_LIST, OPTIMISM_LIST } from './lists'
...
const CHAIN_INFO: ChainInfoMap = {
  ...
  [SupportedChainId.JOC_TESTNET]: {
    networkType: NetworkType.L1,
    blockWaitMsBeforeWarning: ms`10m`,
    bridge: 'https://x-gate.org',
    docs: 'https://www.japanopenchain.org/docs',
    explorer: 'https://explorer.testnet.japanopenchain.org',
    infoLink: 'https://info.uniswap.org/#/joc_testnet',
    label: 'JOC Testnet',
    logoUrl: jocLogo,
    nativeCurrency: { name: 'JOC', symbol: 'JOCT', decimals: 18 },
    defaultListUrl: JOC_LIST,
  },
}
